...
using PosTerminal.Net.Application.Models.ApiResult;
using PosTerminal.Net.Application.Models.Jwt;
using PosTerminal.Net.Infrastructure.Identity.Identity;
using PosTerminal.Net.Infrastructure.Identity.Identity.Dtos;
using PosTerminal.Net.Infrastructure.Identity.Identity.Extensions;
using PosTerminal.Net.Infrastructure.Identity.Identity.Manager;
using PosTerminal.Net.Infrastructure.Identity.Identity.PermissionManager;
using PosTerminal.Net.Infrastructure.Identity.Identity.SeedDatabaseService;
using PosTerminal.Net.Infrastructure.Identity.Identity.Store;
using PosTerminal.Net.Infrastructure.Identity.Identity.validator;
using PosTerminal.Net.Infrastructure.Identity.Jwt;
using PosTerminal.Net.Infrastructure.Identity.UserManager;

namespace PosTerminal.Net.Infrastructure.Identity.ServiceConfiguration;
